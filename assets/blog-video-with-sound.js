(() => {
  const selectors = {
    section: '[data-section-type="blog-video-with-sound"]',
    openButton: '[data-video-sound-open]',
    modal: '[data-video-sound-modal]',
    modalDialog: '.blog-video-sound__video-modal-dialog',
    closeButton: '[data-video-sound-close]',
    modalPlayer: '.blog-video-sound__video-modal-player',
    modalClose: '.blog-video-sound__video-modal-close',
    inlineVideo: '.blog-video-sound__video--inline',
    modalVideo: '.blog-video-sound__video--modal',
    focusable:
